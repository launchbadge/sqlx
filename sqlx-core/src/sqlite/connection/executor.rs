...
use crate::sqlite::statement::{MaybeOwnedStatement, SqliteStatement, StatementHandle};
use crate::sqlite::type_info::DataType;
use crate::sqlite::{
    Sqlite, SqliteArguments, SqliteConnection, SqliteRow, SqliteTypeInfo, SqliteValue,
};
...
impl<'c> Executor<'c> for &'c mut SqliteConnection {
    ...
    #[doc(hidden)]
    fn describe<'q: 'c, E>(self, mut query: E) -> BoxFuture<'c, Result<Describe<Sqlite>, Error>>
    where
        E: Execute<'q, Self::Database>,
    {
