...
use crate::mysql::{MySql, MySqlArguments, MySqlValue, MySqlValueFormat, MySqlValueRef};
...
fn encode_date(date: &NaiveDate, buf: &mut MySqlArguments) {
...
fn encode_time(time: &NaiveTime, include_micros: bool, buf: &mut MySqlArguments) {
