...
// This provides a `Type` implementation for cases when you specifically need a JSON object
// and not another JSON-compatible value (i.e. not an array, Boolean, string, etc.).
