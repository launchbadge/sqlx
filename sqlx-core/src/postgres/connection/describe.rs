...
use crate::postgres::{PgArguments, PgConnection, PgRow, PgTypeInfo, Postgres};
...
impl PgConnection {
    ...
    async fn maybe_fetch_type_info_by_oid(
        ...
        if should_fetch {
            ...
            // TODO: cache the type name <-> oid relationship in a paired hashmap
...
ORDER BY enumsortorder
    ...
    fn fetch_composite_by_oid(
        ...
        Box::pin(async move {
            let mut raw_fields: Vec<(String, u32)> = query_as(
                r#"
