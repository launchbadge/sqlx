pub enum ErrorCodes {
    ...
    ER_UNUSED_11 = 1608,
    ER_NO_FORMAT_DESCRIPTION_EVENT = 1609,
    ...
    ER_BINLOG_MULTIPLE_ENGINES = 1667,
    ...
    ER_BINLOG_UNSAFE_MULTIPLE_ENGINES = 1692,
    ...
    ER_VCOL_BASED_ON_VCOL = 1900,
    ER_VIRTUAL_COLUMN_FUNCTION_IS_NOT_ALLOWED = 1901,
    ER_DATA_CONVERSION_ERROR_FOR_VIRTUAL_COLUMN = 1902,
    ER_PRIMARY_KEY_BASED_ON_VIRTUAL_COLUMN = 1903,
    ER_KEY_BASED_ON_GENERATED_VIRTUAL_COLUMN = 1904,
    ER_WRONG_FK_OPTION_FOR_VIRTUAL_COLUMN = 1905,
    ER_WARNING_NON_DEFAULT_VALUE_FOR_VIRTUAL_COLUMN = 1906,
    ER_UNSUPPORTED_ACTION_ON_VIRTUAL_COLUMN = 1907,
    ER_CONST_EXPR_IN_VCOL = 1908,
    ER_ROW_EXPR_FOR_VCOL = 1909,
    ER_UNSUPPORTED_ENGINE_FOR_VIRTUAL_COLUMNS = 1910,
    ER_UNKNOWN_OPTION = 1911,
    ER_BAD_OPTION_VALUE = 1912,
    // Duplicate error code
    // ER_NETWORK_READ_EVENT_CHECKSUM_FAILURE = 1913,
    // ER_BINLOG_READ_EVENT_CHECKSUM_FAILURE = 1914,
    ER_CANT_DO_ONLINE = 1915,
